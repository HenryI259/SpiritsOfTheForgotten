...
{
	public class SolarShard : ModProjectile
	{
		...
		public override void AI()
		{
			...
			*/
			...
			Dust obj8 = Main.dust[Dust.NewDust(projectile.position, projectile.width, projectile.height, 6, 0, 0, 100, default(Color), 0.5f)];
			...
			obj8.fadeIn = 0.5f;
			obj8.noGravity = true;
			Dust obj9 = Main.dust[Dust.NewDust(projectile.position, projectile.width, projectile.height, 6, 0, 0, 100, default(Color), 0.5f)];
			...
			{
				int num101 = Dust.NewDust(new Vector2(projectile.position.X, projectile.position.Y), projectile.width, projectile.height, 6, 0, 0, 100, default(Color), 0.5f);
        ...
        public override void Kill(int timeLeft)
        {
			...
			{
				Dust.NewDust(new Vector2(projectile.position.X, projectile.position.Y), projectile.width, projectile.height, 6, 0f, 0f, 100, default(Color), 1.5f);
			}
			for (int num265 = 0; num265 < 32; num265++)
			{
				int num266 = Dust.NewDust(new Vector2(projectile.position.X, projectile.position.Y), projectile.width, projectile.height, 6, 0f, 0f, 100, default(Color), 2.5f);
				Main.dust[num266].noGravity = true;
				Dust dust196 = Main.dust[num266];
				Dust dust226 = dust196;
				dust226.velocity *= 3f;
				num266 = Dust.NewDust(new Vector2(projectile.position.X, projectile.position.Y), projectile.width, projectile.height, 6, 0f, 0f, 100, default(Color), 1.5f);
			...
			*/
			for (int num270 = 0; num270 < 5; num270++)
			{
				...
				int num272 = Dust.NewDust(projectile.position, projectile.width, projectile.height, 6, 2.5f * (float)projectile.direction, -2.5f);
