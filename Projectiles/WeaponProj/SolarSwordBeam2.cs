...
{
	public class SolarSwordBeam2 : ModProjectile
	{
		...
		public override void AI()
		{
			...
			int dust = Dust.NewDust(projectile.position, projectile.width, projectile.height, DustID.SolarFlare, projectile.velocity.X, projectile.velocity.Y, 100, default(Color), 1f);
