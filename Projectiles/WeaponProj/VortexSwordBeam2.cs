...
{
	public class VortexSwordBeam2 : ModProjectile
	{
		...
		public override void AI()
		{
			...
			int dust = Dust.NewDust(projectile.position, projectile.width, projectile.height, DustID.Vortex, projectile.velocity.X, projectile.velocity.Y, 100, default(Color), 1f);
